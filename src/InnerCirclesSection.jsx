import { Users, MessageCircle, ShieldCheck, Heart } from "lucide-react";
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <p className="mt-5 text-lg leading-8 text-stone-600">
              ...
              private circles for cousins, close friends, family branches,
              reunions, travel groups, and the people you want to stay close to.
            </p>

            <p className="mt-5 text-lg leading-8 text-stone-600">
              Add people privately for your own map and reminders, then invite
              them only when you are ready to share a Memory Starter, Story Photo,
              or Memory Thread.
            </p>
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            ...
            <InnerCircleCard icon={Heart} title="Create flexible circles">
              Organize people into circles like Cousins, Dad’s Side, Close
              Friends, Reunion 2026, or Charlotte Area Family.
            </InnerCircleCard>
